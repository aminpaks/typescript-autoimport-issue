...
type Index40 = ComputeRange<50>[number];
...
export type SafeFoo = DeepKeys<LimitDepth<Foo>>;

export declare function keys<T extends object>(obj: T): DeepKeys<LimitDepth<T, 18>>;
